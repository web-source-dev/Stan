...
import { FieldControl, ColorField } from './FieldControl';
            ...
            {selected.type === 'header' && (
              <div className="mt-4 space-y-4 border-b border-line pb-5">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button type="button" onClick={pickAvatar} className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-line-strong bg-white px-3 py-1.5 text-sm font-medium shadow-xs hover:bg-surface-muted">
                    <IconImage size={15} /> Upload
                  </button>
                </div>
